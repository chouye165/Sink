...
export function ClawCaptcha({
  ...
  const i18n = {
    en: {
      ...
      infoTag: 'Catch the right toy to prove you’re human.',
      emptyCatch: 'Came up empty. Try again.',
    ...
    zh: {
      ...
      infoTag: '抓住正确的玩具，证明你是人类。',
      emptyCatch: '空手而归。再试一次。',
      ariaLabel: '抓娃娃机验证',
          ...
          >
            ...
            >
              ...
              <div className="clawcap-info-head">
                ...
                <p className="clawcap-info-tag">{texts.infoTag}</p>
              </div>
